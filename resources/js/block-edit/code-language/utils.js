...
export const getLanguages = () =>
	applyFilters("blockwheels.ideas.blockEdit.codeLanguages", LANGUAGES);
 ...
 * @returns {string}
 */
export const updateLanguageClass = (className, newLanguage, oldLanguage) =>
	updateClass(className, newLanguage, oldLanguage, LANGUAGE_PREFIX);
