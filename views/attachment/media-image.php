...
$image   = wp_get_attachment_image_src($data['post_id'], 'blockwheels-16x9-lg');
...
<div class="wp-block-group alignfull">
	...
	<!-- wp:image {
		...
		"sizeSlug":"blockwheels-16x9-lg",
		"linkDestination":"none"
	} -->
	<figure class="wp-block-image alignwide size-blockwheels-16x9-lg">
