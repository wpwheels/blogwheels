 ...
 * Slug: blogwheels/card-character-stack
...
<div class="wp-block-group has-global-border is-style-section-1 has-sm-font-size" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;min-height:100%">
	...
	<div class="wp-block-group has-text-align-center" style="padding-top:var(--wp--preset--spacing--plus-3);padding-right:var(--wp--preset--spacing--plus-3);padding-bottom:var(--wp--preset--spacing--plus-3);padding-left:var(--wp--preset--spacing--plus-3)">
		...
		<!-- wp:group {
			"tagName":"header",
			"metadata":{
				"name":"<?= esc_attr__('Card Header', 'blogwheels') ?>"
			},
			"style":{
				"spacing":{
					"blockGap":"0"
		...
		<header class="wp-block-group">
			...
			<p class="is-style-kicker"><?= esc_html__('Level 99', 'blogwheels') ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"level":3} -->
			<h3 class="wp-block-heading"><?= esc_html__('User Name', 'blogwheels') ?></h3>
			<!-- /wp:heading -->
		...
		<!-- wp:paragraph -->
		<p><?= esc_html(Utils::loremIpsum(12)) ?></p>
		<!-- /wp:paragraph -->
	...
	<footer class="wp-block-group alignfull is-style-section-2" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
		...
		<?php foreach (range(1, 3) as $skill) : ?>
			...
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--base);padding-right:var(--wp--preset--spacing--px);padding-bottom:var(--wp--preset--spacing--base);padding-left:var(--wp--preset--spacing--px)">
				...
				<p class="has-text-align-center has-2-xs-font-size" style="font-style:normal;font-weight:300;text-transform:uppercase"><?= esc_html__('Skill', 'blogwheels') ?></p>
				<!-- /wp:paragraph -->
