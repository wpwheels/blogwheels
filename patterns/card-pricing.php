...
<div class="wp-block-group has-global-border is-style-section-1 has-xs-font-size" style="min-height:0px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
	...
	<header class="wp-block-group" style="padding-top:var(--wp--preset--spacing--plus-3);padding-right:var(--wp--preset--spacing--plus-3);padding-bottom:var(--wp--preset--spacing--plus-3);padding-left:var(--wp--preset--spacing--plus-3)">
		...
		<h3 class="wp-block-heading has-xl-font-size"><?= esc_html__('Placeholder', 'blogwheels') ?></h3>
		<!-- /wp:heading -->

		<!-- wp:paragraph -->
		<p><?= esc_html(Utils::loremIpsum(4)) ?></p>
		<!-- /wp:paragraph -->
	...
	<div class="wp-block-group is-style-section-2" style="padding-top:var(--wp--preset--spacing--base);padding-bottom:var(--wp--preset--spacing--base)">
		...
		<p class="has-7-xl-font-size" style="font-style:normal;font-weight:900"><?= esc_html__('$95', 'blogwheels') ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:paragraph {"fontSize":"xs"} -->
		<p class="has-xs-font-size"><?= esc_html__('/ year', 'blogwheels') ?></p>
		<!-- /wp:paragraph -->
	...
	<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--plus-3);padding-right:var(--wp--preset--spacing--plus-3);padding-bottom:var(--wp--preset--spacing--plus-3);padding-left:var(--wp--preset--spacing--plus-3)">
		...
		<ul class="has-marker-none">
			...
			<?php foreach (range(1, 5) as $item) : ?>
				...
				<li class="<?= esc_attr($style) ?>"><?= esc_html__('Placeholder text', 'blogwheels') ?></li>
				<!-- /wp:list-item -->
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button has-custom-width wp-block-button__width-100">
				<a class="wp-block-button__link wp-element-button" style="padding-top:var(--wp--preset--spacing--minus-1);padding-bottom:var(--wp--preset--spacing--minus-1)"><?= esc_html__('Placeholder Text →', 'blogwheels') ?></a>
			</div>
			<!-- /wp:button -->
