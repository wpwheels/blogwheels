...
?>
<!-- wp:cover {
	"metadata":{"name":"<?= esc_attr__('Hero: Featured', 'blogwheels') ?>"},
	"url":"<?= esc_url($image) ?>",
	"hasParallax":true,
	"dimRatio":100,
	"minHeight":90,
...
<div class="wp-block-cover alignfull has-parallax has-custom-content-position is-position-bottom-left" style="padding-top:var(--wp--preset--spacing--plus-5);padding-right:var(--wp--preset--spacing--plus-3);padding-bottom:var(--wp--preset--spacing--plus-5);padding-left:var(--wp--preset--spacing--plus-3);min-height:90vh">
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group">
			...
			<h1 class="wp-block-heading alignwide has-text-shadow-sm has-5-xl-font-size"><?php esc_html_e("Hello. I&#8217;m Jordan Doe.", 'blogwheels') ?></h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"className":"has-text-shadow-sm","fontSize":"xl"} -->
			<p class="has-text-shadow-sm has-xl-font-size"><?php esc_html_e('Wanderer — Adventurer', 'blogwheels') ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"className":"has-text-shadow-sm"} -->
			<p class="has-text-shadow-sm"><?php esc_html_e("I&#8217;ve walked miles upon miles of desert, climbed mountains, and soared through the skies. Yet, there is so much more to do—a thousand more lifetimes to live, loves to love, and journeys to trek.", 'blogwheels') ?></p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button is-style-outline">
					<a class="wp-block-button__link wp-element-button"><?php esc_html_e('More About Me →', 'blogwheels') ?></a>
				</div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
